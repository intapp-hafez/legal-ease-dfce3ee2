...
const toneMap: Record<string, string> = {
  ...
  "مُسندة": "bg-accent/15 text-accent border-accent/30",
  "موقّع": "bg-accent/15 text-accent border-accent/30",
  "قيد المراجعة": "bg-warning/15 text-warning border-warning/30",
  "قيد المعالجة": "bg-warning/15 text-warning border-warning/30",
  "قيد التنفيذ": "bg-accent/15 text-accent border-accent/30",
  "قيد التحقيق": "bg-warning/15 text-warning border-warning/30",
  "بانتظار": "bg-warning/15 text-warning border-warning/30",
  "بانتظار الإرجاع": "bg-warning/15 text-warning border-warning/30",
  صيانة: "bg-warning/15 text-warning border-warning/30",
  ...
  مفتوحة: "bg-accent/15 text-accent border-accent/30",
  "أمام المحكمة": "bg-accent/15 text-accent border-accent/30",
