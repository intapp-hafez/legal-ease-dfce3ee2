...
import { useCategories, useStatuses, type OptionsApi } from "@/lib/custody-options";
...
export function CustodyOptionsSettings() {
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-2">
      <OptionManager
        title="فئات الأصول"
        api={categories}
        placeholder="اسم فئة جديدة (مثال: كاميرا)"
      />
      <OptionManager
        title="حالات العهدة"
        api={statuses}
        placeholder="اسم حالة جديدة (مثال: قيد الفحص)"
      />
    </div>
  );
}
